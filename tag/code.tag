<code>
  <div id = "container-left">
    <h2 id = "greeting">Call me Hackerwoman.</h2>
    <div id = "text">
      <div class = "talk">
        <p class = "title">Featured Projects</p>
        <p class = "more"><a href = "https://github.com/alainakafkes/emojifai" class = "link">Emojifai</a> (WIP)</p>
        <p class = "more"><a href = "https://github.com/alainakafkes/clarifaing-gender-roles" class = "link">Clarifaing Gender Roles</a></p>
        <p class = "more"><a href = "https://github.com/alainakafkes/give-back" class = "link">Give Back</a></p>
      </div>
      <div class = "talk">
        <p class = "title">Interdisciplinary Hacks</p>
        <p class = "more"><a href = "https://github.com/alainakafkes/temple-digitization" class = "link">Digitization of Selected Poems from The Temple</a></p>
      </div>
      <div class = "talk">
